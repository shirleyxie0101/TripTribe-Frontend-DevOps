        ...
        >
          ...
          >
            {hasRestaurantData
              ...
              : 'No Favorite Restaurants yet, could you please change that?'}
          </Typography>
          {!hasRestaurantData && ( // Check if the array is empty
            <Link href="/restaurants">
              <Button
                sx={{ bgcolor: primaryLight, color: 'white', mt: 2, borderRadius: '20px' }} // Styling for the button
              >
        ...
        >
          ...
          {!hasAttractionData && (
            <Link href="/attractions">
              <Button sx={{ bgcolor: primaryLight, color: 'white', mt: 2, borderRadius: '20px' }}>
